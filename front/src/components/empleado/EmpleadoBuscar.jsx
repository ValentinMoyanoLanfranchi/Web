...
export default function EmpleadoBuscar ({DescripcionCargo, setDescripcionCargo, Activo, setActivo, Buscar, Agregar}) {
      ...
      <div className="container-fluid">
        <div className="row">
          <div className="col-sm-4 col-md-2">
            <label className="col-form-label">DescripcionCargo:</label>
          </div>
